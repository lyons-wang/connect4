...
module HumanvsAI = Referee(MyConnect4.Connect4, 
  (HumanPlayer.HumanPlayer(MyConnect4.Connect4)), 
  (AIPlayer.AIPlayer(MyConnect4.Connect4)));

HumanvsAI.playGame();

module HumanVsHuman = Referee(MyConnect4.Connect4, 
  (HumanPlayer.HumanPlayer(MyConnect4.Connect4)), 
  (HumanPlayer.HumanPlayer(MyConnect4.Connect4)));

HumanVsHuman.playGame();

// module AIvsAI = Referee(MyConnect4.Connect4, 
//   (AIPlayer.AIPlayer(MyConnect4.Connect4)), 
//   (AIPlayer.AIPlayer(MyConnect4.Connect4)));
